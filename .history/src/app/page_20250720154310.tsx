      ...
      <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden bg-gray-900">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6 max-w-lg mx-auto">
            ...
            <a href="tel:02-1234-5678" className="bg-white/10 backdrop-blur-md border-2 border-white/30 text-white px-10 py-5 text-lg font-semibold rounded-xl hover:bg-white/20 hover:border-white/50 transition-all duration-300 shadow-xl">
              <span className="flex items-center justify-center">
