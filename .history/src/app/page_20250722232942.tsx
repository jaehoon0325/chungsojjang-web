      ...
      <section id="services" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-blue-900 font-semibold text-sm tracking-wide uppercase">PROFESSIONAL SERVICES</span>
          ...
          {/* 주요업무 - 한줄 강조 형태 */}
          <div className="mb-16">
            <div className="bg-gradient-to-r from-blue-900 to-slate-800 rounded-3xl shadow-2xl p-8 lg:p-12 text-white relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-wrap justify-center gap-4 lg:gap-6">
                  <div className="group flex items-center bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full border border-white/20 hover:bg-white/20 hover:border-white/40 transition-all duration-300">
                    <div className="w-3 h-3 bg-amber-400 rounded-full mr-3 group-hover:scale-125 transition-transform"></div>
                    <span className="font-semibold text-lg">건물관리</span>
                  </div>
                  <div className="group flex items-center bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full border border-white/20 hover:bg-white/20 hover:border-white/40 transition-all duration-300">
                    <div className="w-3 h-3 bg-emerald-400 rounded-full mr-3 group-hover:scale-125 transition-transform"></div>
                  ...
                  <div className="group flex items-center bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full border border-white/20 hover:bg-white/20 hover:border-white/40 transition-all duration-300">
                    <div className="w-3 h-3 bg-rose-400 rounded-full mr-3 group-hover:scale-125 transition-transform"></div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              ...
              <div className="group relative overflow-hidden rounded-2xl aspect-square">
                ...
                <div className="absolute top-3 right-3">
                  <span className="bg-purple-500/90 text-white px-2 py-1 text-xs font-bold rounded">홈</span>
                </div>
              </div>
              ...
              <div className="group relative overflow-hidden rounded-2xl aspect-square">
                ...
                <div className="absolute top-3 right-3">
                  <span className="bg-amber-500/90 text-white px-2 py-1 text-xs font-bold rounded">홈</span>
                </div>
              </div>
              ...
              <div className="group relative overflow-hidden rounded-2xl aspect-square">
                ...
                <div className="absolute top-3 right-3">
                  <span className="bg-blue-500/90 text-white px-2 py-1 text-xs font-bold rounded">오피스</span>
                </div>
              </div>
              ...
              <div className="group relative overflow-hidden rounded-2xl aspect-square">
                ...
                <div className="absolute top-3 right-3">
                  <span className="bg-emerald-500/90 text-white px-2 py-1 text-xs font-bold rounded">오피스</span>
                </div>
              </div>
              ...
              <div className="group relative overflow-hidden rounded-2xl aspect-square">
                ...
                <div className="absolute top-3 right-3">
                  <span className="bg-rose-500/90 text-white px-2 py-1 text-xs font-bold rounded">홈</span>
                </div>
              </div>
              ...
              <div className="group relative overflow-hidden rounded-2xl aspect-square">
                ...
                <div className="absolute top-3 right-3">
                  <span className="bg-indigo-500/90 text-white px-2 py-1 text-xs font-bold rounded">오피스</span>
                </div>
              </div>
              ...
              <div className="group relative overflow-hidden rounded-2xl aspect-square">
                ...
                <div className="absolute top-3 right-3">
                  <span className="bg-teal-500/90 text-white px-2 py-1 text-xs font-bold rounded">오피스</span>
                </div>
              </div>
              ...
              <div className="group relative overflow-hidden rounded-2xl aspect-square">
                ...
                <div className="absolute top-3 right-3">
                  <span className="bg-orange-500/90 text-white px-2 py-1 text-xs font-bold rounded">홈</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="group bg-white rounded-3xl shadow-2xl overflow-hidden hover:shadow-3xl transition-all duration-300 hover:-translate-y-1">
              <div className="relative">
                <div className="aspect-[4/3] bg-cover bg-center relative"
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent"></div>
                  <div className="absolute top-4 left-4">
                    <span className="bg-purple-500 text-white px-3 py-1 text-xs font-bold rounded-full">NEW HOME</span>
                  </div>
                  <div className="absolute bottom-4 left-4 text-white">
                    <h4 className="text-lg font-bold mb-1">아파트 입주 전문 청소</h4>
                    <p className="text-sm text-gray-200">원주시 · 84㎡ · 소요시간: 6시간</p>
                  </div>
                </div>
              </div>
              <div className="p-8">
                <div className="flex items-center mb-4">
                  ...
                  <span className="text-sm text-gray-500 ml-2">새 출발</span>
                </div>
                <p className="text-gray-600 leading-relaxed mb-4">
                  새 아파트 입주를 위한 완벽한 청소 서비스입니다. 건축 먼지와 시공 잔여물을 깔끔하게 제거하여 새집 증후군을 예방하고, 가족이 안심하고 생활할 수 있는 환경을 조성했습니다.
                </p>
                <div className="flex items-center text-sm text-gray-500 space-x-4">
                  <div className="flex items-center">
                  ...
                  <div className="flex items-center">
                    <svg className="w-4 h-4 mr-1 text-emerald-500" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M3 10a7 7 0 019.307-6.611 1 1 0 00.658-1.889 9 9 0 105.98 7.501 1 1 0 00-1.988.22A7 7 0 013 10z" clipRule="evenodd" />
                      <path fillRule="evenodd" d="M13.657 5.343a1 1 0 00-1.414 0L9 8.586 7.757 7.343a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4a1 1 0 000-1.414z" clipRule="evenodd" />
                    </svg>
                    입주 준비 완료
                  </div>
                </div>
