...
const sampleTestimonials: Omit<CustomerTestimonial, 'id' | 'createdAt'>[] = [
  {
    ...
    rating: 5,
    imageUrl: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", // 청소 도구
    featured: true
  },
  {
    customerName: "박○○ 과장",
  ...
  },
  {
    ...
    rating: 5,
    imageUrl: "https://images.unsplash.com/photo-1497366216548-37526070297c?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", // 깔끔한 사무실
    featured: true
  },
  {
    customerName: "정○○님",
  ...
  },
  {
    ...
    rating: 4,
    imageUrl: "https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", // 깨끗한 집
    featured: false
  }
];
