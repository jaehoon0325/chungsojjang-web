            ...
            {isMounted && (
              user ? (
                <div className="space-y-4">
                  {/* 로그인된 사용자 정보 */}
                  <div className="flex items-center justify-center space-x-3 mb-4" suppressHydrationWarning>
                    {user.photoURL && (
                      <Image
                        src={user.photoURL}
                        alt="프로필"
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-gray-600 text-sm mb-4">
                    후기를 작성하려면 Google 계정으로 로그인해 주세요
                  </p>
                  
                  {/* 로그인 버튼 */}
                  <button
                    onClick={signInWithGoogle}
                    className="flex items-center justify-center space-x-3 bg-white border-2 border-gray-300 px-6 py-3 rounded-xl hover:bg-gray-50 transition-colors duration-200 font-medium mx-auto"
                    suppressHydrationWarning
                  >
                    ...
                    <span className="text-gray-700">Google로 로그인 후 후기 작성</span>
                  </button>
                </div>  
              )
            )}
